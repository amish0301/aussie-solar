...
const navMenuData: MenuItem[] = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      { id: 4.4, label: "Solar Panel Installation", link: "/services-details/1" },
  ...
  },
  {
    ...
    subMenu: [  
      {
        id: 5.1, label: "Residential Solar", link: "/packages/residential-solar", hasDropdown: true, subMenu: [
          { id: 5.2, label: "6.6kW Solar System", link: '/package-details/101' },
          { id: 5.3, label: "7.92kW Solar System", link: '/package-details/102' },
          { id: 5.4, label: "10.12kW Solar System", link: '/package-details/103' },
          { id: 5.5, label: "13.2kW Solar System", link: '/package-details/104' },
          { id: 5.6, label: "Custom Size Solution", link: '/contact' },
        ]
      },
      {
        id: 16, label: "Commercial Solar", link: "/packages/commercial-solar", hasDropdown: true, subMenu: [
          { id: 16.2, label: "20kW Solar System", link: '/package-details/201' },
          { id: 16.3, label: "30kW Solar System", link: '/package-details/202' },
          { id: 16.4, label: "50kW Solar System", link: '/package-details/203' },
          { id: 16.5, label: "100kW Solar System", link: '/package-details/204' },
